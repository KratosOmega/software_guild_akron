                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td class="tbDescription">Material Cost</td>
                                                <td class="tbValue">$ ${data.get("materialCost")}</td>
                                            </tr>
                                            <tr>
                                                <td class="tbDescription">Labor Cost</td>
                                                <td class="tbValue">$ ${data.get("laborCost")}</td>
                                            </tr>
                                            <tr>
                                                <td class="tbDescription">Total Cost</td>
                                                <td class="tbValue">$ ${data.get("totalCost")}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <hr>
