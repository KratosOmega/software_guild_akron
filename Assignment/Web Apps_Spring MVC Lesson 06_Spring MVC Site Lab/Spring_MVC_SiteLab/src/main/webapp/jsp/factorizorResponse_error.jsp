...
<html>
    <head>
        <title>Site Lab - Factorizor</title>
        <!-- Bootstrap core CSS -->
            ...
            <div id="navBar" class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="nav nav-pills bg-info center-block">
                        ...
                        <li role="siteNavigator" class="active"><a href="${pageContext.request.contextPath}/factorizor/index">Factorizor</a></li>
                ...
                <div class="text-center col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-inline" role="getInput" name="index" action="${pageContext.request.contextPath}/factorizor/calculate" method="POST">
                                <h3>Enter a number to factor</h3>
                                <br>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="numToFactor" placeholder="Start @ 2">
                                    </div>
                                </div>
