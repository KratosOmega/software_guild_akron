...
//    //********************************************************* drop down list - do this later
    ...
    $('#add-button').click(function (event) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                title: $('#dvd-title').val(),
                releaseDate: $('#dvd-releaseDate').val(),
                mmpaRating: $('#dvd-mmpaRating').val(),
                director: $('#dvd-director').val(),
                studio: $('#dvd-studio').val(),
                note: $('#dvd-note').val()
            }),
    ...
    $('#edit-button').click(function (event) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                ...
                mmpaRating: $('#edit-dvd-mmpaRating').val(),
...
function deleteDvd(id) {
    var answer = confirm('Do you really want to delete this dvd record?');
...
$('#detailsModal').on('show.bs.modal', function (event) {
    ...
    $.ajax({
        ...
        modal.find('#details-dvd-id').text(dvd.id);
        modal.find('#details-dvd-title').text(dvd.title);
        modal.find('#details-dvd-releaseDate').text(dvd.releaseDate);
    });
});
...
$('#editModal').on('show.bs.modal', function (event) {
    ...
    $.ajax({
        ...
        modal.find('#edit-dvd-mmpaRating').val(dvd.mmpaRating);
