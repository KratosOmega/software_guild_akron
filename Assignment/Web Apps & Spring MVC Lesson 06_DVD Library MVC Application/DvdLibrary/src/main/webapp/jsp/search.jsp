                ...
                <div class="col-md-4">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="search-note" placeholder="Note" />
                            </div>
                        </div>

                        <div class="col-md-offset-4 col-md-8">
                            <button type="submit" id="search-button" class="btn btn-primary">Search DVD</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h2>Edit DVD</h2>
                            <form class="form-horizontal" role="form" action="searchEdit" method="POST">
                                <div class="form-group">
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="delteDetailsModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h2>Delete DVD</h2>
                            <form class="form-horizontal" role="form" action="searchDelete" method="POST">
                                <div class="form-group">
